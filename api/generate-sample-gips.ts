...
const sampleGIPs = [
  {
    ...
    fullProposal: `As the Protocol Engineer of GrokChain, I propose implementing an AI-driven dynamic block size adjustment system.
...
This system will create a more efficient and fair economic ecosystem for GrokChain.`,
...
This framework will ensure GrokChain remains a fair and inclusive platform for all users.`,
...
This framework will ensure GrokChain remains secure in the quantum era.`,
